              ...
              <div className="p-3">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  {item.isVeg !== undefined && (
                    <div
                      className={`w-40 h-4 border rounded ${item.isVeg ? "border-green-600" : "border-red-600"
                        }`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full mx-auto mt-0.5 ${item.isVeg ? "bg-green-600" : "bg-red-600"
                          }`}
                      ></div>
                    </div>
                  )}
                ...
                <div className="flex items-center justify-between ">
                  <div className="flex items-center gap-1.5 ">
                    <button
                      ...
                      className="w-8 h-8 bg-gray-200 rounded flex items-center justify-center hover:bg-gray-300 text-gray-600 font-bold text-md"
                    >
                      −
                    </button>
                  ...
                  <button
                    ...
                    className="bg-red-600 text-white px-5 py-1.5 rounded-md text-md h-10 font-medium hover:bg-red-700 transition-colors"
                  >
                    Add To Cart
                  </button>
                </div>
